...
namespace Shamotj\PdoProfilerBundle\DataCollector;
...
class TraceablePDO extends PDO
{
    ...
    {
        $this->pdo = $pdo;
        $this->pdo->setAttribute(PDO::ATTR_STATEMENT_CLASS, array('Shamotj\PdoProfilerBundle\DataCollector\TraceablePDOStatement', array($this)));
    }
